...
(() => {
    ...
    const skills = ['HTML', 'Java', 'Ajax', 'Python', 'Computer Network Wiring', 'MySQL','CSS', 'Bootstrap', 'Jquery', 'SASS'];

    const skills2 = ['SQL', 'JavaScript', 'Spring Boot', 'Swift', 'SQLite', 'Responsive Web Design'];
